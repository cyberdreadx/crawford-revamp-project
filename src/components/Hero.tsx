            ...
            <div className="space-y-6">
              ...
              delay: 0.8
                ...
                delay: 1.0
                  ...
                  <span className="text-primary font-bold text-shadow-glow text-4xl sm:text-5xl md:text-6xl lg:text-7xl">C</span>Creating
                </motion.div>
                <motion.div className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white/90 font-medium tracking-wide" style={{
                textShadow: '0 2px 10px rgba(0,0,0,0.7)'
              }} initial={{
                ...
                delay: 1.4
                  ...
                  <span className="text-primary font-bold text-shadow-glow text-4xl sm:text-5xl md:text-6xl lg:text-7xl">R</span>Referrable
                </motion.div>
                <motion.div className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white/90 font-medium tracking-wide" style={{
                textShadow: '0 2px 10px rgba(0,0,0,0.7)'
              }} initial={{
                ...
                delay: 1.4
                  ...
                  <span className="text-primary font-bold text-shadow-glow text-4xl sm:text-5xl md:text-6xl lg:text-7xl">E</span>Experience
                </motion.div>
              </motion.div>
            </div>
          </motion.div>
