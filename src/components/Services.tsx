...
import { Home, TrendingUp, Search, FileText, Calculator, Users, Shield, Clock, Award } from "lucide-react";
...
const Services = () => {
  ...
  return <section id="services" className="py-20 bg-gradient-subtle">
              ...
              y: -10
                  ...
                  <Card className="group p-6 shadow-card hover:shadow-elegant transition-all duration-300 border-0">
                    <CardContent className="p-0">
                      <motion.div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-gold rounded-full mb-6" whileHover={{
                    scale: 1.1,
                    rotate: 5
                  }} transition={{
                    type: "spring",
                    stiffness: 300
                      ...
                      <motion.h3 className="text-xl font-semibold text-foreground mb-3 group-hover:text-accent transition-colors" whileHover={{
                    x: 5
                  }} transition={{
                    type: "spring",
                    stiffness: 300
                      ...
                      <ul className="space-y-2">
                        {service.features.map((feature, featureIndex) => <motion.li key={featureIndex} className="flex items-center text-sm text-muted-foreground" initial={{
                      opacity: 0,
                      x: -20
                    }} whileInView={{
                      opacity: 1,
